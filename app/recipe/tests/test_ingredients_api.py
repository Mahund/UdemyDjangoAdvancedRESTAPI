...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_update_ingredient(self):
        ...
        ingredient = Ingredient.objects.create(user=self.user, name='Ingredient5')  # noqa: E501
    ...
    def test_delete_ingredient(self):
        ...
        ingredient = Ingredient.objects.create(user=self.user, name='Ingredient6')  # noqa: E501
        url = detail_url(ingredient.id)
