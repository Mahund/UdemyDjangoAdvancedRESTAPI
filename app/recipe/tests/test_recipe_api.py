...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        ...
        other_user = create_user(email='other@example.com', password='testpass123')  # noqa: E501
    ...
    def test_update_user_returns_error(self):
        ...
        new_user = create_user(email='user2@example.com', password='testpass123')  # noqa: E501
        recipe = create_recipe(user=self.user)
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        ingredient = Ingredient.objects.create(user=self.user, name='Ingredient1')  # noqa: E501
        payload = {
            'title': 'Sample recipe',
            'time_minutes': 30,
            'price': Decimal('5.99'),
    ...
    def test_create_ingredient_on_update(self):
        ...
        res = self.client.patch(url, payload, format='json')
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        new_ingredient = Ingredient.objects.get(user=self.user, name='Ingredient1')  # noqa: E501
        self.assertIn(new_ingredient, recipe.ingredients.all())

    def test_update_recipe_assign_ingredient(self):
        """Test assigning an existing ingredient when updating a recipe."""
        ingredient_1 = Ingredient.objects.create(user=self.user, name='Ingredient1')  # noqa: E501
        recipe = create_recipe(user=self.user)
        recipe.ingredients.add(ingredient_1)

        ingredient_2 = Ingredient.objects.create(user=self.user, name='Ingredient2')  # noqa: E501
